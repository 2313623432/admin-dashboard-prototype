...
export function LogisticsManagement() {
  ...
  function createSampleLogs(): OperationLog[] {
    return [
      { id: 'log-01', time: '2026-05-13 15:30', operator: '管理员', action: '编辑', orderNo: 'ORD20260501001' },
      { id: 'log-02', time: '2026-05-13 14:20', operator: '管理员', action: '取消订单并退分', orderNo: 'ORD20260502008', pointsRefunded: 880, reason: '用户主动申请取消，地址填写错误' },
      { id: 'log-03', time: '2026-05-13 11:05', operator: '管理员', action: '标记订单异常', orderNo: 'ORD20260503002', reason: '快递公司反馈地址不存在，需联系用户确认' },
      { id: 'log-04', time: '2026-05-12 16:50', operator: '管理员', action: '编辑', orderNo: 'ORD20260504005' },
      { id: 'log-05', time: '2026-05-12 10:15', operator: '管理员', action: '导入3条数据', orderNo: 'ORD20260505001', orderNos: ['ORD20260503018', 'ORD20260501001'] },
      { id: 'log-06', time: '2026-05-12 09:30', operator: '管理员', action: '取消异常状态', orderNo: 'ORD20260504022' },
      { id: 'log-07', time: '2026-05-11 17:22', operator: '管理员', action: '取消订单并退分', orderNo: 'ORD20260501001', pointsRefunded: 500, reason: '商品缺货，协商后用户同意取消' },
      { id: 'log-08', time: '2026-05-11 15:08', operator: '管理员', action: '编辑', orderNo: 'ORD20260502015' },
      { id: 'log-09', time: '2026-05-11 13:40', operator: '管理员', action: '标记订单异常', orderNo: 'ORD20260503018', reason: '收货地址不完整，缺少门牌号' },
      { id: 'log-10', time: '2026-05-11 10:00', operator: '管理员', action: '导入5条数据', orderNo: 'ORD20260505001', orderNos: ['ORD20260504005', 'ORD20260504022', 'ORD20260503018', 'ORD20260502015'] },
      { id: 'log-11', time: '2026-05-10 16:30', operator: '管理员', action: '编辑', orderNo: 'ORD20260505001' },
      { id: 'log-12', time: '2026-05-10 11:55', operator: '管理员', action: '取消订单并退分', orderNo: 'ORD20260502008', pointsRefunded: 880, reason: '商品破损退换' },
    ];
  }
  ...
  const handleConfirmImport = () => {
    ...
    const importedOrderNos = importPreview.success.map(r => r.orderNo);
    setOperationLogs(prev => [
      {
        id: `log-${Date.now()}`,
        time: nowString(),
        operator: '管理员',
        action: `导入${importPreview.success.length}条数据`,
        orderNo: importedOrderNos[0] || '',
        orderNos: importedOrderNos.length > 1 ? importedOrderNos.slice(1) : undefined,
      },
      ...prev,
    ]);
  };
